create table temp_carbrandname_1_1ji_7_16 as 
select carbrandname,p_hour,msisdn from (
    ...
    from  default.d_ens_http_4g where p_hour in (2022071608,2022071609,
    2022071610)
...
select carbrandname,p_hour,msisdn from (
    ...
    from  default.d_ens_http_4g where p_hour in (
      2022071611,2022071612,2022071613
    )
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
...
select carbrandname,p_hour,msisdn from (
    ...
    from  default.d_ens_http_4g where p_hour in (2022071614,2022071615,
    2022071616)
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
...
select carbrandname,p_hour,msisdn from (
    ...
    from  default.d_ens_http_4g where p_hour in (2022071617,2022071618,2022071619)
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
    and substr(msisdn,1,3)<>'144' 
...
select carbrandname,p_hour,msisdn from (
    ...
    from  default.d_ens_http_4g where p_hour in (2022071620,2022071621,
    2022071622)
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
...
select carbrandname,p_hour,msisdn from (
    ...
    from  default.d_ens_http_4g where p_hour in (2022071623,2022071624)
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
    and substr(msisdn,1,3)<>'144' 
...
----------------------2级------------------------
create table temp_carname_1_2ji_7_16 as 
select carname,p_hour,msisdn from (
    ...
    CASE
     ...
     from  default.d_ens_http_4g where p_hour in (2022071608,2022071609,2022071610)
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
    and substr(msisdn,1,3)<>'144' 
...
select carname,p_hour,msisdn from (
    ...
    CASE
     ...
     from  default.d_ens_http_4g where p_hour in (2022071611,2022071612,2022071613)
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
    and substr(msisdn,1,3)<>'144' 
...
select carname,p_hour,msisdn from (
    ...
    CASE
     ...
     from  default.d_ens_http_4g where p_hour in (2022071614,2022071615,2022071616)
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
    and substr(msisdn,1,3)<>'144' 
...
select carname,p_hour,msisdn from (
    ...
    CASE
     ...
     from  default.d_ens_http_4g where p_hour in (2022071620,2022071621,2022071622)
    and HOST in ('car3.autoimg.cn','car2.autoimg.cn')
    and substr(msisdn,1,1)='1' 
    and substr(msisdn,1,3)<>'106' 
    and substr(msisdn,1,3)<>'144' 
...
--------------------------3级----------------------------
create table temp_carname_1_3ji_7_16 as 
